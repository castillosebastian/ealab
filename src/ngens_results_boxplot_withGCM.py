...
sns.boxplot(ax=ax4, x='group', y='pob_ngenes_avg', data=gcm, palette=custom_palette)
sns.stripplot(ax=ax4, x='group', y='pob_ngenes_avg', data=gcm, color='darkgrey', dodge=True)
axes[1, 1].set_xlabel('')
ax4.set_title('GCM')
...
plt.tight_layout()
plt.savefig('expga1/boxplot_ngenes_results_wGCM.png')
plt.show()
