...
# Parameters----------------------------------------------------------------------------------
exp_dir = root + "/exp/exp_36_BO_VAE2_MLP_leukemia_latent_dim/"
dataset_name = 'leukemia'
class_column = 'CLASS'
# BO
n_trials = 100
param_ranges = {
    'hiden1': {'low': 2000, 'high': 2000},
    'hiden2': {'low': 1000, 'high': 1000},
    'latent_dim': {'low': 50, 'high': 1000},
    'lr': {'low': 0.0009674, 'high': 0.0009674},
    #'epochs': {'low': 1, 'high': 1}
    'epochs': {'low': 1000, 'high': 2000}
}
n_samples = 140
# Evaluate
evaluate = False
