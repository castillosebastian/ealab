...
pipeline = Pipeline([
    ("scaler", StandardScaler()),
    ("mlp", MLPClassifier(max_iter=max_iter, random_state=1))  # Adjust parameters as needed
])
...
Evaluation Report for MLP Classifier with StandardScaler:
   ...
   Colorectal       0.75      1.00      0.86         3
     Lymphoma       1.00      0.83      0.91         6
      Bladder       0.00      0.00      0.00         3
     Melanoma       0.40      1.00      0.57         2
Uterus__Adeno       0.40      1.00      0.57         2
     Leukemia       1.00      0.83      0.91         6
        Renal       0.00      0.00      0.00         3
     Pancreas       0.43      1.00      0.60         3
        Ovary       0.50      0.67      0.57         3
 Mesothelioma       1.00      0.67      0.80         3
          CNS       1.00      1.00      1.00         4

     accuracy                           0.63        46
    macro avg       0.50      0.60      0.51        46
 weighted avg       0.59      0.63      0.58        46

"""

# EPOCH 1000
"""
valuation Report for MLP Classifier with StandardScaler:
               precision    recall  f1-score   support
...
Overall Weighted F1 Score: 0.5843591191417279
"""
