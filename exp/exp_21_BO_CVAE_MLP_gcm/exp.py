...
# Parameters----------------------------------------------------------------------------------
exp_dir = root + "/exp/exp_21_BO_CVAE_MLP_gcm/"
dataset_name = 'gcm'
class_column = 'class'
num_classes = 14
# BO
...
print(f'Label data after scale and encode class: {traindata_set.labels}')
...
labels = [i for i in range(num_classes)]  # The two labels you want to condition on
