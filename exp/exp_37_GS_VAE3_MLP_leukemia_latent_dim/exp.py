...
# Parameters----------------------------------------------------------------------------------
exp_dir = root + "/exp/exp_37_GS_VAE3_MLP_leukemia/"
...
n_trials = 2
# Define your grid
hiden1_range = (50, 50, 50, 50, 50)
hiden2_range = (30, 30, 30, 30, 30)
hiden3_range = (20, 20, 20, 20, 20)
latent_dim_range = (3, 10, 20, 50, 100)
lr_range = (0.0001, 0.0001,0.0001,0.0001,0.0001,)
epochs = 1000
