...
# params
experiment_name = "leukemia_base_0000"
description = "Set up mlflow"
...
GMAX = 1               # Cantidad máxima de generaciones que se ejecutará el algoritmo
