...
# params
experiment_name = "gcm_base_0032"
description = "gene01_and_testsynth_origialtestset"
...
toolbox.register("attribute", bin, p=0.3)  # Nombre con el que se registra el componente
...
# combine original data and sythetic data
Xtrain = np.concatenate([Xtrain, X_train_fake], axis=0)
y_train = np.concatenate([y_train, y_train_fake], axis=0)
#Xtest = np.concatenate([Xtest, X_test_fake], axis=0)
#y_test = np.concatenate([y_test, y_test_fake], axis=0)
