...
plt.title('Highly Correlated Features (Above 90%)')
plt.savefig('highly_correlated_features_09.png', dpi=300)
plt.show()
...
with open('correlation_stats.txt', 'w') as f:
    f.write(f"Number of variables with correlation above 90%: {total_high_corr}\n")
    f.write(f"Percentage of the feature space with correlation above 90%: {percentage_of_feature_space:.2f}%\n")
