...
# params
experiment_name = "leukemia_base_0010"
description = "multiexperiments_with_syn100VAE_equal_objectives_30features"
...
toolbox.register("attribute", bin, p=0)  # Nombre con el que se registra el component
...
class_column = 'CLASS'
train_df, test_df, scaler, df_base, class_mapping = load_and_standardize_data_thesis(root, dataset_name, class_column, selected_features=True)
cols = df_base.columns
D_in = train_df.shape[1]
traindata_set = DataBuilder(root, dataset_name, class_column, train=True, selected_features=True)
testdata_set = DataBuilder(root, dataset_name, class_column, train=False, selected_features=True)
